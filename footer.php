...
<footer class="footer-pc is-pc is-tab">
  <div class="footer-pc__inner">
    ...
    <a href="index.html" class="footer-pc__logo">
      <img class="footer-pc__logo-img" src="<?php echo get_template_directory_uri(); ?>/./images/ico/ico_logo.png" alt="Yukuro CreateFolio">
    </a>
    <!-- ===== フッターロゴ Footer-Logo ===== -->
    ...
    <div class="footer-pc__sns-box">
      <div class="footer-pc__sns-item">
        <a class="footer-pc__sns-link" href="Twitter:URL">
          <img class="footer-pc__sns-icon" src="<?php echo get_template_directory_uri(); ?>/./images/ico/ico_twitter-footer.svg" alt="Twitter">
        </a>
      </div>
      <div class="footer-pc__sns-item">
        <a class="footer-pc__sns-link" href="Instagram:URL">
          <img class="footer-pc__sns-icon" src="<?php echo get_template_directory_uri(); ?>/./images/ico/ico_instagram-footer.svg" alt="Instagram">
        </a>
      </div>
      <div class="footer-pc__sns-item">
        <a class="footer-pc__sns-link" href="Pinterest:URL">
          <img class="footer-pc__sns-icon" src="<?php echo get_template_directory_uri(); ?>/./images/ico/ico_pinterest-footer.svg" alt="Pinterest">
        </a>
      </div>
    </div>
    <!-- ===== SNSナビ SNS-Nav ===== -->
...
<footer class="footer-sp is-sp">
  ...
  <a href="index.html" class="footer-sp__logo">
    <img class="footer-sp__logo-img" src="<?php echo get_template_directory_uri(); ?>/./images/ico/ico_logo.png" alt="Yukuro CreateFolio">
  </a>
  <!-- ===== フッターロゴ Footer-Logo ===== -->
  ...
  <div class="footer-sp__sns-box">
    <div class="footer-sp__sns-item">
      <a class="footer-sp__sns-link" href="Twitter:URL">
        <img class="footer-sp__sns-icon" src="<?php echo get_template_directory_uri(); ?>/./images/ico/ico_twitter-footer.svg" alt="Twitter">
      </a>
    </div>
    <div class="footer-sp__sns-item">
      <a class="footer-sp__sns-link" href="Instagram:URL">
        <img class="footer-sp__sns-icon" src="<?php echo get_template_directory_uri(); ?>/./images/ico/ico_instagram-footer.svg" alt="Instagram">
      </a>
    </div>
    <div class="footer-sp__sns-item">
      <a class="footer-sp__sns-link" href="Pinterest:URL">
        <img class="footer-sp__sns-icon" src="<?php echo get_template_directory_uri(); ?>/./images/ico/ico_pinterest-footer.svg" alt="Pinterest">
      </a>
    </div>
  </div>
  <!-- ===== SNSナビ SNS-Nav ===== -->
...
<script src="<?php echo get_template_directory_uri(); ?>/javascript/form.js"></script>
