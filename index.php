    ...
    <div class="main-visual__inner main-visual__inner--vh">
      ...
      <header class="header-top is-pc is-tab is-top-header">
        <nav class="header-top__nav">
          <!-- ロゴリンク -->
          <a class="header-top__top-link" href="<?php echo home_url(); ?>">
            <h1 class="header-top__logo">
              <img class="header-top__logo-img" src="<?php echo get_template_directory_uri(); ?>/images/ico/ico_logo.png" alt="Yukuro CreateFolio">
            </h1>
          </a>
        ...
        <section class="contents__wrapper">
          ...
          <div class="top-works">
            <div class="top-works__thumb">
              <img class="top-works__image" src="<?php echo get_template_directory_uri(); ?>/images/img/img_top-works-webthumb.jpg" alt="Webサイト制作">
            </div>
              ...
              <div class="top-works__mockup-box">
                ...
                <div class="top-works__mockup-item">
                  ...
                  <a class="top-works__mockup" href="制作詳細ページURL">
                    <img class="top-works__mock-image" src="<?php echo get_template_directory_uri(); ?>/images/img/img_top-works_webmockup.png" alt="YuCoRea モックアップ">
                  </a>
                </div>
                ...
                <div class="top-works__mockup-item">
                  ...
                  <a class="top-works__mockup" href="制作詳細ページURL">
                    <img class="top-works__mock-image" src="<?php echo get_template_directory_uri(); ?>/images/img/img_top-works_webmockup.png" alt="Cafe MITAKE モックアップ">
                  </a>
                </div>
              </div>
            </div>
        ...
        <section class="contents__wrapper">
          ...
          <div class="top-works top-works--odd">
            <div class="top-works__thumb top-works__thumb--odd">
              <img class="top-works__image" src="<?php echo get_template_directory_uri(); ?>/images/img/img_top-works-devthumb.jpg" alt="プログラミング">
            </div>
            ...
            <div class="top-works__desc">
              ...
              <div class="top-works__mockup-box">
                ...
                <div class="top-works__mockup-item">
                  ...
                  <a class="top-works__mockup" href="制作詳細ページURL">
                    <img class="top-works__mock-image" src="<?php echo get_template_directory_uri(); ?>/images/img/img_top-works-phonemockup.png" alt="YuCoRea モックアップ">
                  </a>
                </div>
                ...
                <div class="top-works__mockup-item">
                  ...
                  <a class="top-works__mockup" href="制作詳細ページURL">
                    <img class="top-works__mock-image" src="<?php echo get_template_directory_uri(); ?>/images/img/img_top-works_webmockup02.png" alt="Cafe MITAKE モックアップE">
                  </a>
                </div>
              </div>
            </div>
        ...
        <section class="contents__wrapper">
          ...
          <div class="top-works top-works">
            <div class="top-works__thumb top-works__thumb">
              <img class="top-works__image" src="<?php echo get_template_directory_uri(); ?>/images/img/img_top-works-uiuxthumb.jpg" alt="プログラミング">
            </div>
            ...
            <div class="top-works__desc">
              ...
              <div class="top-works__mockup-box">
                ...
                <div class="top-works__mockup-item">
                  ...
                  <a class="top-works__mockup" href="制作詳細ページURL">
                    <img class="top-works__mock-image" src="<?php echo get_template_directory_uri(); ?>/images/img/img_top-works-phonemockup.png" alt="デリバリーショップUI モックアップ">
                  </a>
                </div>
                ...
                <div class="top-works__mockup-item">
                  ...
                  <a class="top-works__mockup" href="制作詳細ページURL">
                    <img class="top-works__mock-image" src="<?php echo get_template_directory_uri(); ?>/images/img/img_top-works-phonemockup.png" alt="運動管理アプリUI モックアップ">
                  </a>
                </div>
              </div>
            </div>
      ...
      <article class="contents__article" id="about-top">
        ...
        <section class="top-about">
          ...
          <div class="top-about__profile-img">
            <img class="top-about__image" src="<?php echo get_template_directory_uri(); ?>/images/img/img_top_profile-img.png" alt="プロフィール写真">
          </div>
        </section>
        ...
        <div class="top-blog">
            ...
            <ul class="tab__list">
              <li class="tab__item">
                <a class="tab__link" href="#program-design_blog">
                  <img class="tab__icon" src="<?php echo get_template_directory_uri(); ?>/blog/images/ico/ico_program-web-category.svg" alt="Web制作/開発・デザイン">
                  Web制作/開発・デザイン
                </a>
              </li>
              <li class="tab__item">
                <a class="tab__link" href="#molding-dress_blog">
                  <img class="tab__icon" src="<?php echo get_template_directory_uri(); ?>/blog/images/ico/ico_molding-category.svg" alt="ハンドメイド">
                  ハンドメイド
                </a>
              </li>
            </ul>
          ...
          <div id="program-design_blog" class="tab__area">
            ...
            <article class="blog-card">
              ...
              <a class="blog-card__thumb" href="/blog/article_sample.html">
                <img class="blog-card__image" src="<?php echo get_template_directory_uri(); ?>/blog/images/img/img_programing-thumb06.jpg" alt="記事のタイトルが入ります。">
              </a>
            ...
            <article class="blog-card">
              <!-- ブログサムネイル -->
              <a class="blog-card__thumb" href="/blog/article_sample.html">
                <img class="blog-card__image" src="<?php echo get_template_directory_uri(); ?>/blog/images/img/img_programing-thumb05.jpg" alt="記事のタイトルが入ります。">
              </a>
              <!-- ブログタイトル / カテゴリー / 投稿日 -->
              <div class="blog-card__label">
                <h4 class="blog-card__title">
            ...
            <article class="blog-card">
              <!-- ブログサムネイル -->
              <a class="blog-card__thumb" href="/blog/article_sample.html">
                <img class="blog-card__image" src="<?php echo get_template_directory_uri(); ?>/blog/images/img/img_programing-thumb04.jpg" alt="記事のタイトルが入ります。">
              </a>
              <!-- ブログタイトル / カテゴリー / 投稿日 -->
              <div class="blog-card__label">
                <h4 class="blog-card__title">
            ...
            <article class="blog-card">
              <!-- ブログサムネイル -->
              <a class="blog-card__thumb" href="/blog/article_sample.html">
                <img class="blog-card__image" src="<?php echo get_template_directory_uri(); ?>/blog/images/img/img_programing-thumb01.jpg" alt="記事のタイトルが入ります。">
              </a>
              <!-- ブログタイトル / カテゴリー / 投稿日 -->
              <div class="blog-card__label">
                <h4 class="blog-card__title">
          ...
          <div id="molding-dress_blog" class="tab__area">
            ...
            <article class="blog-card">
              <!-- ブログサムネイル -->
              <a class="blog-card__thumb" href="/blog/article_sample.html">
                <img class="blog-card__image" src="<?php echo get_template_directory_uri(); ?>/blog/images/img/img_molding-thumb05.jpg" alt="記事のタイトルが入ります。">
              </a>
              <!-- ブログタイトル / カテゴリー / 投稿日 -->
              <div class="blog-card__label">
                <h4 class="blog-card__title">
            ...
            <article class="blog-card">
              <!-- ブログサムネイル -->
              <a class="blog-card__thumb" href="/blog/article_sample.html">
                <img class="blog-card__image" src="<?php echo get_template_directory_uri(); ?>/blog/images/img/img_molding-thumb02.jpg" alt="記事のタイトルが入ります。">
              </a>
              <!-- ブログタイトル / カテゴリー / 投稿日 -->
              <div class="blog-card__label">
                <h4 class="blog-card__title">
            ...
            <article class="blog-card">
              <!-- ブログサムネイル -->
              <a class="blog-card__thumb" href="/blog/article_sample.html">
                <img class="blog-card__image" src="<?php echo get_template_directory_uri(); ?>/blog/images/img/img_handmade-thumb01.jpg" alt="記事のタイトルが入ります。">
              </a>
              <!-- ブログタイトル / カテゴリー / 投稿日 -->
              <div class="blog-card__label">
                <h4 class="blog-card__title">
            ...
            <article class="blog-card">
              <!-- ブログサムネイル -->
              <a class="blog-card__thumb" href="/blog/article_sample.html">
                <img class="blog-card__image" src="<?php echo get_template_directory_uri(); ?>/blog/images/img/img_molding-thumb03.jpg" alt="記事のタイトルが入ります。">
              </a>
              <!-- ブログタイトル / カテゴリー / 投稿日 -->
              <div class="blog-card__label">
                <h4 class="blog-card__title">
        ...
        <div class="blog-category">
          ...
          <div class="blog-category__item">
            <a href="blog/web-design_category.html" class="blog-category__thumb-link">
              ...
              <img class="blog-category__image" src="<?php echo get_template_directory_uri(); ?>/blog/images/img/img_blog-category_programing-visual.jpg" alt="Web制作/開発・デザイン">
            </a>
          ...
          <div class="blog-category__item">
            <a href="blog/handmade_category.html" class="blog-category__thumb-link">
              ...
              <img class="blog-category__image" src="<?php echo get_template_directory_uri(); ?>/blog/images/img/img_blog-category_molding-visual.jpg" alt="ハンドメイド">
            </a>
            <ul class="blog-category__category-list">
              <li class="blog-category__category-item">
      ...
      <article class="contents__article" id="news-top">
        ...
        <ul class="news-list">
          <li class="news-list__item">
            <time class="news-list__date">2022<br><span class="news-list__date news-list__date--lg">04.05</span></time>
          ...
          <li class="news-list__item">
            <time class="news-list__date">2022<br><span class="news-list__date news-list__date--lg">03.23</span></time>
          ...
          <li class="news-list__item">
            <time class="news-list__date">2022<br><span class="news-list__date news-list__date--lg">02.26</span></time>
