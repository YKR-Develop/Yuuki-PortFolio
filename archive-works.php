    ...
    <article class="contents__article contents__article--white-bg" id="production-overview">
      ...
      <section class="works-category">
        ...
        <a class="works-category__item" href="<?php echo get_term_link('illustrator', 'works-cat'); ?>">
          <div class="works-category__thumb">
            <img class="works-category__image" src="http://yukuro-createfolio.local/wp-content/uploads/2023/03/img_category-thumb_illustrator.jpg" alt="Illustrator">
          </div>
          <div class="works-category__label-inner">
            <h3 class="works-category__label">
        ...
        <a class="works-category__item" href="<?php echo get_term_link('handmade-works', 'works-cat'); ?>">
          <div class="works-category__thumb">
            <img class="works-category__image" src="http://yukuro-createfolio.local/wp-content/uploads/2023/03/img_category-thumb_moldingdress.jpg" alt="ハンドメイド">
          </div>
          <div class="works-category__label-inner">
            <h3 class="works-category__label">
        ...
        <div class="works-tab-contents">
            ...
            <ul class="tab__list" id="tab">
              <li class="tab__item tab__item--about">
                <a class="tab__link" href="#website-works">
                  <img class="tab__icon" src="http://yukuro-createfolio.local/wp-content/uploads/2023/04/ico_works-website.svg" alt="Webサイト">
                  Webサイト
                </a>
              </li>
              <li class="tab__item tab__item--about">
                <a class="tab__link" href="#uiux-works">
                  <img class="tab__icon" src="http://yukuro-createfolio.local/wp-content/uploads/2023/04/ico_works-uiuxdesign.svg" alt="UI UXデザイン">
                  UI UXデザイン
                </a>
              </li>
              <li class="tab__item tab__item--about">
                <a class="tab__link" href="#photoshop-works">
                  <img class="tab__icon" src="http://yukuro-createfolio.local/wp-content/uploads/2023/04/ico_works-photoshop.svg" alt="PhotoShop">
                  PhotoShop
                </a>
              </li>
              <li class="tab__item tab__item--about">
                <a class="tab__link" href="#illustrator-works">
                  <img class="tab__icon" src="http://yukuro-createfolio.local/wp-content/uploads/2023/04/ico_works-illustrator.svg" alt="Illustrator">
                  Illustrator
                </a>
              </li>
              <li class="tab__item tab__item--about">
                <a class="tab__link" href="#molding-works">
                  <img class="tab__icon" src="http://yukuro-createfolio.local/wp-content/uploads/2023/04/ico_works-molding.svg" alt="ハンドメイド">
                  ハンドメイド
                </a>
              </li>
            </ul>
          ...
          <div id="website-works" class="tab__area">
            ...
            <div class="primary-button">
              <a class="primary-button__link" href="http://yukuro-createfolio.local/works-cat/web-site/">Webサイト 一覧
          ...
          <div id="uiux-works" class="tab__area">
            ...
            <!-- ===== ページ遷移ボタン ===== -->
            <div class="primary-button">
              <a class="primary-button__link" href="http://yukuro-createfolio.local/works-cat/ui-ux-design/">UI UXデザイン 一覧
                <span class="primary-button__arrow"></span></a>
            </div>
          </div>
          <!-- ⬆︎ /////////////////// UI UXデザイン End /////////////////// ⬆︎ -->
          ...
          <div id="photoshop-works" class="tab__area">
            ...
            <!-- ===== ページ遷移ボタン ===== -->
            <div class="primary-button">
              <a class="primary-button__link" href="http://yukuro-createfolio.local/works-cat/photoshop/">PhotoShop 一覧
                <span class="primary-button__arrow"></span></a>
            </div>
          </div>
          <!-- ⬆︎ /////////////////// PhotoShop End /////////////////// ⬆︎ -->
          ...
          <div id="illustrator-works" class="tab__area">
            ...
            <!-- ===== ページ遷移ボタン ===== -->
            <div class="primary-button">
              <a class="primary-button__link" href="http://yukuro-createfolio.local/works-cat/illustrator/">Illustrator 制作実績
                <span class="primary-button__arrow"></span></a>
            </div>
          </div>
          <!-- ⬆︎ /////////////////// Illustrator End /////////////////// ⬆︎ -->
          ...
          <div id="molding-works" class="tab__area">
            ...
            <!-- ===== ページ遷移ボタン ===== -->
            <div class="primary-button">
              <a class="primary-button__link" href="http://yukuro-createfolio.local/works-cat/handmade/">ハンドメイド 一覧
                <span class="primary-button__arrow"></span></a>
            </div>
          </div>
          <!-- ⬆︎ /////////////////// ハンドメイド End /////////////////// ⬆︎ -->
